...
class DeclarationPass : public ASTVisitor<DeclarationPass> {
public:
    DeclarationPass(SymbolTable& symbols, SemanticModel& model, Diagnostics& diagnostics);

    using ASTVisitor<DeclarationPass>::visit;
